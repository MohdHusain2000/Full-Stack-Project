...
export const signUp = createAction('[Auth] Sign Up',props<{ user: UserRegister }>());
export const signUpSuccess = createAction('[Auth] Sign Up Success',props<{ user: UserRegister }>());
